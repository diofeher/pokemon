...
const REGION_HOTSPOTS: {
  ...
  { id: "galar", x: 9, y: 35, w: 10, h: 7, color: "#f97316" },
  { id: "paldea", x: 26, y: 39, w: 10, h: 7, color: "#a855f7" },
  { id: "kalos", x: 37, y: 30, w: 10, h: 7, color: "#ec4899" },
  { id: "unova", x: 38, y: 53, w: 10, h: 7, color: "#8b5cf6" },
